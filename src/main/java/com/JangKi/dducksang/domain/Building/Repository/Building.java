...
public class Building {
    ...
    @Column
    private String Bonbun; // 법정동 본번 코드

    @Column
    private String Bubun; // 법정동 부번 코드
    ...
    @Builder
    public Building(Year buildYear, Long code, int sigunguCode, int eupmyundongCode, String sigungu, String dong, String aptName, Address address, List<Sales> salesList, String roadBuildingCode, String roadSubBuildingCode, String roadName, String Bonbun, String Bubun)
    {
